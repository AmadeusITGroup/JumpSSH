# -*- coding: utf-8 -*-
#
# jumpssh documentation build configuration file, created by
# sphinx-quickstart on Mon Mar 27 05:09:52 2017.
#
...
latex_documents = [
    (master_doc, 'jumpssh.tex', u'jumpssh Documentation', author, 'manual'),
]
...
man_pages = [
    (master_doc, 'jumpssh', u'jumpssh Documentation', [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'jumpssh', u'jumpssh Documentation', author, 'jumpssh',
